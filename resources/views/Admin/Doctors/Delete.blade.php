         ...
         <div class="col-md-12">
            ...
            @method("DELETE")
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="DoctorName" name="DoctorName" value="{{ $doctor->DoctorName }}" disabled>
               </div>
               <div class="form-group">
                  <label for="Speciality">Speciality</label>
                  <input type="text" class="form-control" id="Speciality" name="Speciality" value="{{ $doctor->Speciality }}" disabled>
               </div>
               <div class="row">
                  <div class="form-group col-md-6">
                        <label for="MobileNumber">Mobile Number</label>
                        <input type="tel" class="form-control" id="MobileNumber" name="MobileNumber" value="{{ $doctor->MobileNumber }}" disabled>
                  </div>
